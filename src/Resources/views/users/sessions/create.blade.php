                ...
                <x-admin::form :action="route('admin.session.store')">
                    ...
                    @if(Route::has('google.authenticate'))
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            >
                            <img 
                                src="{{ asset('vendor/google-auth/googlesymbol.svg') }}"
                                alt="Microsoft Logo"
                                class="w-6 h-6 mr-2"
                            >
                            <span>{{ __('google-auth::app.sign-in') }}</span>
                            </a>
                        </div>
                    @endif
                </x-admin::form>
